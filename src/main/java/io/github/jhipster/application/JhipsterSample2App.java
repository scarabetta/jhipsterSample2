...
public class JhipsterSample2App {

    private static final Logger log = LoggerFactory.getLogger(JhipsterSample2App.class);

    private final Environment env;

    public JhipsterSample2App(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterSample2.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterSample2App.class);
